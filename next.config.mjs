...
const nextConfig = {
  ...
  async redirects() {
    const issueMap = [
      // Phase 1 legacy slugs -> revised Phase 3 slugs
      ['2026-08-05-process-before-prediction', '2026-08-06-why-most-investors-need-a-process'],
      ['2026-08-12-qqq-growth-engine-or-concentration-risk', '2026-08-13-qqq-growth-engine-or-concentration-risk'],
      ['2026-08-19-what-leaps-add-to-systematic-strategy', '2026-08-20-what-leaps-actually-add'],
      ['2026-08-26-pmcc-managed-trade-off', '2026-08-27-pmcc-is-not-free-income'],
      ['2026-09-02-smh-put-selling-not-hedging-qqq', '2026-09-03-why-smh-puts-are-not-a-hedge'],
      ['2026-09-09-what-machine-learning-can-and-cannot-do', '2026-09-10-what-ml-can-and-cannot-do'],
      ['2026-09-16-backtest-assumptions-must-survive-scrutiny', '2026-09-17-backtests-only-matter-if-assumptions-survive'],
      ['2026-09-23-risk-framework-drawdown-exposure-discipline', '2026-09-24-building-a-retail-risk-framework'],
      // First Phase 3 slugs -> revised Phase 3 slugs
      ['2026-08-06-why-most-retail-investors-need-a-process', '2026-08-06-why-most-investors-need-a-process'],
      ['2026-08-13-is-qqq-a-growth-engine-or-a-concentration-risk', '2026-08-13-qqq-growth-engine-or-concentration-risk'],
      ['2026-08-20-what-leaps-actually-add-to-a-systematic-strategy', '2026-08-20-what-leaps-actually-add'],
      ['2026-09-03-why-selling-puts-on-smh-is-not-a-hedge', '2026-09-03-why-smh-puts-are-not-a-hedge'],
      ['2026-09-10-what-machine-learning-can-do-for-investors', '2026-09-10-what-ml-can-and-cannot-do'],
      ['2026-09-17-backtest-results-only-matter-if-assumptions-survive', '2026-09-17-backtests-only-matter-if-assumptions-survive'],
    ];
    return [
      ...
      { source: '/newsletter/systematic-investing-framework', destination: '/newsletter/start-here', permanent: true },
      { source: '/newsletter/qqq-strategy-overview', destination: '/newsletter/guides/qqq', permanent: true },
      { source: '/newsletter/risk-control-framework', destination: '/newsletter/research/risk-framework', permanent: true },
      { source: '/newsletter/semiconductor-sleeve-guide', destination: '/newsletter/guides/smh-puts', permanent: true },
      { source: '/newsletter/methodology-assumptions', destination: '/newsletter/research/backtest-validation', permanent: true },
      { source: '/newsletter/options-risk-faq', destination: '/risk-disclosure', permanent: true },
      { source: '/newsletter/portfolio-discipline-guide', destination: '/newsletter/research/risk-framework', permanent: true },
      { source: '/newsletter/update-email', destination: '/newsletter/change-email', permanent: true },
      { source: '/newsletter/subscribe', destination: '/upgrade', permanent: true },
      { source: '/subscribe', destination: '/upgrade', permanent: true },

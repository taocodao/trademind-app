        ...
        <main className="min-h-screen bg-[#0A0A0F] text-[#F8FAFC] px-6 py-10">
            <div className="mx-auto max-w-3xl">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-2xl font-bold">Import Lead Data</h1>
                </div>
                <p className="text-sm text-[#8B95A9] mb-8">
                    Upload a lead list CSV in the standard template. Rows are keyed by Email:
                    new addresses are inserted, existing ones are updated. Columns that are
                    completely empty or only contain "Not Available" are ignored.
                </p>

                {/* Upload card */}
                <div className="rounded-2xl border border-[#232333] bg-[#14141f] p-6 mb-6">
                    <div
                ...
                {/* Stats */}
                <div className="rounded-2xl border border-[#232333] bg-[#14141f] p-6">
                    <h2 className="text-sm font-semibold uppercase tracking-wide text-[#8B95A9]">
                        Database {total !== null && <span className="text-white normal-case">({total.toLocaleString()} leads total)</span>}
                    </h2>
                    {batches.length === 0 ? (

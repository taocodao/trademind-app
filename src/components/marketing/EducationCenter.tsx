...
export function EducationCenter() {
    ...
    const ALL_DOCUMENTS = React.useMemo(() => [
        ...
        {
            id: 'report-en',
            title: 'TurboCore Report (Archive)',
            description: 'Archived research report for the former TurboCore strategy (retired 2026).',
        ...
        },
        {
            ...
            description: 'Archived market analysis for the former TurboCore strategy (retired 2026).',
        ...
        {
            id: 'report-es',
            title: 'Informe TurboCore (Archivo)',
            description: 'Informe archivado de la antigua estrategia TurboCore (retirada en 2026).',
        ...
        },
        {
            ...
            description: 'Análisis archivado de la antigua estrategia TurboCore (retirada en 2026).',
        ...
        {
            id: 'report-zh',
            title: 'TurboCore 主要报告（存档）',
            description: '已停用策略 TurboCore 的存档研究报告（2026年退役）。',
        ...
        },
        {
            id: 'comp-zh',
            title: '2026 竞争分析报告',
            description: '已停用策略 TurboCore 的存档市场分析（2026年退役）。',
    ...
    // ── Report Viewer Modal (Portal) ──────────────────────────────────────────
    // Rendered via createPortal so it mounts at document.body, completely
    // escaping any parent stacking context (z-index, transform, filter, etc.).
    // This fixes the "Transparent Pricing" banner showing over the modal.
    const modal = isViewerOpen && typeof document !== 'undefined'
        ? createPortal(
            <div className="fixed inset-0 z-[9999] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 sm:p-8">

...
/* RetirementSection — the "cash-poor, retirement-rich" pain-point band.
   ...
   then the internal link mesh to /verify and /verify/ledger.
   The slogan and the asterisked illustration moved out of this band in v3:
   the slogan now lives above the hero h1, and the $10K-to-$1M arithmetic
   lives in hero Card 1 plus the /verify illustration module. */

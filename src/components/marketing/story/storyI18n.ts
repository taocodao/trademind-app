...
const es: StoryOverlay = {
    chapters: {
        ...
        ch2: {
            kicker: 'Capítulo 2', title: 'El motor',
        ...
        ch3: {
            kicker: 'Capítulo 3', title: 'La cobertura',
        ...
        map: {
            kicker: 'Capítulo 4', title: 'El mapa',
        ...
        ch4: {
            kicker: 'Capítulo 5', title: 'El drawdown',
        ...
        ch5: {
            kicker: 'Capítulo 6', title: 'La comparación honesta',
        ...
        ch6: {
            kicker: 'Capítulo 7', title: 'En vivo, ahora mismo',
        ...
        ch7: {
            kicker: 'Capítulo 8', title: 'Juzga tú mismo',
    ...
    hero: {
        ...
        h1a: 'Un historial,', h1b: 'leído en voz alta.',
        sub: 'Cinco años y medio de decisiones: un mercado alcista, un año bajista en efectivo, una corrección, y cada precio en el camino. Sin cherry-picking. Sin bombo.',
        play: '▶ Comenzar la historia',
        hintNarrated: '11 diapositivas · sincronizado con audio · ~7 minutos · transcripción completa en la última diapositiva',
        hintSilent: '11 diapositivas · una lectura de 7 minutos · metodología completa dentro',
        note: 'Pulsa reproducir para comenzar la historia.',
    },
    ui: {
        // slide titles
        ch1title: '2 de septiembre de 2025', ch2title: 'Un contrato, cien acciones',
        ...
        disc2p: ' Las opciones implican un riesgo sustancial y no son adecuadas para todos los inversores; puedes perder toda tu inversión. TradeMind nunca se conecta a tu bróker ni envía órdenes — las señales solo te ayudan a ingresar la orden tú mismo. Esta página es material educativo, no asesoría de inversión ni una solicitud.',
...
const zh: StoryOverlay = {
    ...
    hero: {
        ...
        h1a: '一份交易记录,', h1b: '读给你听。',
        sub: '五年半的每一个决策——一轮牛市、一年空仓避熊、一次回调,以及沿途的每一个价格。不挑数据。不吹牛。',
        play: '▶ 开始聆听',
        hintNarrated: '11页 · 语音同步 · 约7分钟 · 完整文字稿在最后一页',
        hintSilent: '11页 · 约7分钟读完 · 内含完整方法论',
        note: '按播放键开始。',
    },
    ui: {
        // slide titles
        ch1title: '2025年9月2日', ch2title: '一张合约,一百股',
        ...
        disc2p: ' 期权涉及重大风险,并不适合所有投资者;你可能损失全部投资。TradeMind从不连接你的券商或提交订单——信号只是帮助你自己下单。本页面为教育材料,非投资建议或要约。',

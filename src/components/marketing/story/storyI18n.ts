...
const es: StoryOverlay = {
    ...
    ui: {
        ...
        playLbl: '▶ Reproducir', pauseLbl: '❚❚ Pausa', homeLbl: '⌂ Inicio',
        ch4from: 'ene 2021', ch4to: 'ago 2026 · $169,249',
        ch4aria: 'Curva de capital de la estrategia, enero 2021 a agosto 2026',
    },
    beats: [
        { label: 'En efectivo, 7 semanas, 0 operaciones', tip: 'Ene to feb 2021 · ninguna entrada válida · portafolio plano en $30,000 mientras QQQ subía' },
        ...
        { label: 'El año bajista, en efectivo', tip: 'Abr 2022 to abr 2023 · capturó la primera caída (−9.5%), luego plano 12 meses mientras QQQ caía −35.6% de pico a valle' },
        { label: 'Nuestro peor hoyo · −17.8%', tip: '5 sep to 26 oct 2023 · $62,103 → $51,067 · el apalancamiento cortó en ambos sentidos' },
        ...
        { label: 'La corrección de 2026', tip: 'Ene to mar 2026 · motor del modelo −10.0% · motor de cinta real −30.4%, publicamos ambos' },
...
const zh: StoryOverlay = {
    ...
    ui: {
        ...
        playLbl: '▶ 播放', pauseLbl: '❚❚ 暂停', homeLbl: '⌂ 首页',
        ch4from: '2021年1月', ch4to: '2026年8月 · $169,249',
        ch4aria: '策略净值曲线,2021年1月至2026年8月',
    },
    beats: [
        { label: '空仓,7周,0笔交易', tip: '2021年1 to 2月 · 无合格入场 · 组合持平于$30,000,QQQ却在上涨' },
        ...
        { label: '2026年回调', tip: '2026年1 to 3月 · 模型引擎−10.0% · 真实行情引擎−30.4%,两者都公布' },

...
export function ShareSection({ promoCode, referralLink, userTier, isCreator }: ShareSectionProps) {
    ...
    return <>
        <div className="space-y-4 rounded-2xl border border-tm-purple/20 bg-gradient-to-br from-tm-purple/10 to-transparent p-5">
            <div className="flex items-start gap-3"><Gift className="mt-0.5 h-5 w-5 text-purple-300" /><p className="text-sm leading-relaxed text-zinc-300">Your friend gets about two extra months ($50 in subscription days) at first payment. Once they stay active for 14 days, you get $100 in subscription days to apply to any of your accounts.</p></div>
            <div>
